...
export function ChatReceptionTest({
  ...
  return (
    <section
      ...
      aria-labelledby="chat-reception-heading"
    >
            ...
            <>
              ...
              {test.messages.length > 0 && (
                <div className="mt-4">
                  ...
                  <ol
                    className="mt-2 max-h-80 space-y-2 overflow-y-auto rounded-lg border bg-background p-3"
                    aria-label="테스트 수신 채팅"
                  >
                    {test.messages.map((message) => (
                      <li
                        key={message.sequence}
                        className="break-words rounded-md bg-muted/40 px-3 py-2 text-sm"
                      >
              ...
              {[
                ...
                <p className="mt-3 text-sm text-amber-700">
                  입장 또는 수신 연결이 끝났습니다. 방송·쿠키 상태를 확인한 뒤
                  새 테스트를 시작하세요.
                </p>
              )}
            </>
