...
export function BroadcastPanelEditor({ value, rules, change }: {
  ...
  return <Card>
    ...
    <CardContent>
      ...
      <div id={`${idPrefix}-panel-dice-price`} role="tabpanel" aria-labelledby={`${idPrefix}-tab-dice-price`} hidden={selectedPanel !== "dice-price"} className="space-y-4 pt-4">
        ...
        <div className="h-20 max-w-md"><BroadcastPanel kind="dice_price" layout={value} rules={rules} /></div>
      </div>
      <div id={`${idPrefix}-panel-menu`} role="tabpanel" aria-labelledby={`${idPrefix}-tab-menu`} hidden={selectedPanel !== "menu"} className="space-y-4 pt-4">
        <div className="grid gap-4 sm:grid-cols-2">
        ...
        <div className="h-80 max-w-sm"><BroadcastPanel kind="menu" layout={value} rules={rules} /></div>
      </div>
    </CardContent>
  </Card>;
}
