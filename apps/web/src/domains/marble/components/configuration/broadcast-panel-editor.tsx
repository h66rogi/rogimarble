...
export function BroadcastPanelEditor({ value, rules, change }: {
  ...
  return <div className="space-y-5">
    <Card><CardHeader><CardTitle>주사위 가격 패널</CardTitle></CardHeader><CardContent className="space-y-4">
    ...
    <Card><CardHeader><CardTitle>메뉴판 패널</CardTitle></CardHeader><CardContent className="space-y-4">
      <div className="grid gap-4 sm:grid-cols-2">
    ...
    <p className="text-sm text-muted-foreground">패널 표시·위치·크기는 OBS 탭의 실시간 배치 편집에서 바꿀 수 있어요.</p>
  </div>;
}
